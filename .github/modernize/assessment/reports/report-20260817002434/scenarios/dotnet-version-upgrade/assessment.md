...
| [tests/PublicApiIntegrationTests/PublicApiIntegrationTests.csproj](#testspublicapiintegrationtestspublicapiintegrationtestscsproj) | net8.0 | 🟢 Low | 3 | 11 | 0 | 11+ | DotNetCoreApp, Sdk Style = True |
...
| Microsoft.AspNetCore.Authentication.JwtBearer | 8.0.2 | 10.0.11 | [PublicApi.csproj](#srcpublicapipublicapicsproj)<br/>[Web.csproj](#srcwebwebcsproj) | NuGet package upgrade is recommended |
| Microsoft.AspNetCore.Components.Authorization | 8.0.2 | 10.0.11 | [BlazorAdmin.csproj](#srcblazoradminblazoradmincsproj) | NuGet package upgrade is recommended |
| Microsoft.AspNetCore.Components.WebAssembly | 8.0.2 | 10.0.11 | [BlazorAdmin.csproj](#srcblazoradminblazoradmincsproj) | NuGet package upgrade is recommended |
| Microsoft.AspNetCore.Components.WebAssembly.Authentication | 8.0.2 | 10.0.11 | [BlazorAdmin.csproj](#srcblazoradminblazoradmincsproj) | NuGet package upgrade is recommended |
| Microsoft.AspNetCore.Components.WebAssembly.DevServer | 8.0.2 | 10.0.11 | [BlazorAdmin.csproj](#srcblazoradminblazoradmincsproj) | NuGet package upgrade is recommended |
| Microsoft.AspNetCore.Components.WebAssembly.Server | 8.0.2 | 10.0.11 | [Web.csproj](#srcwebwebcsproj) | NuGet package upgrade is recommended |
| Microsoft.AspNetCore.Diagnostics.EntityFrameworkCore | 8.0.2 | 10.0.11 | [PublicApi.csproj](#srcpublicapipublicapicsproj)<br/>[Web.csproj](#srcwebwebcsproj) | NuGet package upgrade is recommended |
| Microsoft.AspNetCore.Identity.EntityFrameworkCore | 8.0.2 | 10.0.11 | [Infrastructure.csproj](#srcinfrastructureinfrastructurecsproj)<br/>[PublicApi.csproj](#srcpublicapipublicapicsproj)<br/>[Web.csproj](#srcwebwebcsproj) | NuGet package upgrade is recommended |
| Microsoft.AspNetCore.Identity.UI | 8.0.2 | 10.0.11 | [PublicApi.csproj](#srcpublicapipublicapicsproj)<br/>[Web.csproj](#srcwebwebcsproj) | NuGet package upgrade is recommended |
| Microsoft.AspNetCore.Mvc.Testing | 8.0.2 | 10.0.11 | [FunctionalTests.csproj](#testsfunctionaltestsfunctionaltestscsproj)<br/>[PublicApiIntegrationTests.csproj](#testspublicapiintegrationtestspublicapiintegrationtestscsproj) | NuGet package upgrade is recommended |
| Microsoft.EntityFrameworkCore.InMemory | 8.0.2 | 10.0.11 | [FunctionalTests.csproj](#testsfunctionaltestsfunctionaltestscsproj)<br/>[Infrastructure.csproj](#srcinfrastructureinfrastructurecsproj)<br/>[IntegrationTests.csproj](#testsintegrationtestsintegrationtestscsproj)<br/>[PublicApi.csproj](#srcpublicapipublicapicsproj)<br/>[Web.csproj](#srcwebwebcsproj) | NuGet package upgrade is recommended |
| Microsoft.EntityFrameworkCore.SqlServer | 8.0.2 | 10.0.11 | [Infrastructure.csproj](#srcinfrastructureinfrastructurecsproj)<br/>[PublicApi.csproj](#srcpublicapipublicapicsproj)<br/>[Web.csproj](#srcwebwebcsproj) | NuGet package upgrade is recommended |
| Microsoft.EntityFrameworkCore.Tools | 8.0.2 | 10.0.11 | [PublicApi.csproj](#srcpublicapipublicapicsproj)<br/>[Web.csproj](#srcwebwebcsproj) | NuGet package upgrade is recommended |
| Microsoft.Extensions.Identity.Core | 8.0.2 | 10.0.11 | [BlazorAdmin.csproj](#srcblazoradminblazoradmincsproj) | NuGet package upgrade is recommended |
| Microsoft.Extensions.Logging.Configuration | 8.0.0 | 10.0.11 | [BlazorAdmin.csproj](#srcblazoradminblazoradmincsproj) | NuGet package upgrade is recommended |
...
| System.Net.Http.Json | 8.0.0 | 10.0.11 | [BlazorAdmin.csproj](#srcblazoradminblazoradmincsproj) | NuGet package upgrade is recommended |
...
| System.Text.Json | 8.0.3 | 10.0.11 | [ApplicationCore.csproj](#srcapplicationcoreapplicationcorecsproj) | NuGet package upgrade is recommended |
